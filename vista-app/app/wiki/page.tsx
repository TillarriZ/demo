      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          <CardBody>
            ...
            <p className="text-sm text-slate-500">Пошаговые инструкции по процессам.</p>
          </CardBody>
        </Card>
        <Card>
          <CardBody>
            <h3 className="font-semibold text-slate-800 mb-2">Правила и регламенты</h3>
            <p className="text-sm text-slate-500">Внутренние правила и стандарты.</p>
          </CardBody>
        </Card>
        <Card>
          <CardBody>
            <h3 className="font-semibold text-slate-800 mb-2">Технологии операций</h3>
            <p className="text-sm text-slate-500">Описание технологий и процедур.</p>
          </CardBody>
        </Card>
      </div>
    </div>
